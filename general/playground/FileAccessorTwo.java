        ...
        try (
            ...
            FileChannel channel = outputStream.getChannel();
                ...
                while((line = reader.readLine()) != null) {
                    if(lock == null) {
                        lockCount++;
                        System.out.println("Two lock requested");
                        ...
                        System.out.println("Two lock acquired : " + lockCount);
                    }
                    writer.println("Two : " + line);
                    writer.flush();
                    count++;
                    totalCount++;
                    if(count == 20) {
                        ...
                        date = new Date();
                        System.out.println(format.format(date));
                        System.out.println("Two : Up and running......");
                    }
                }
            } catch(IOException ioe) {
                ioe.printStackTrace();
