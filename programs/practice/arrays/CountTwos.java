public class CountTwos {
  ...
  /**
   * Count number of 2's in digit d (0 is least significant digit) e.g. 25, d=1 (tens place)
   *
   * <p>Output : 3 {20, 21, 22, 23, 24, 25} Note : 22 has 2 Twos
   */
  ...
  /** Count number of 2's in all digits e.g. 25 */
