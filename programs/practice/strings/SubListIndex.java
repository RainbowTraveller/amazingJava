/**
 * Leetcode: https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/ Given
 * two lists, find the index of the first occurrence of list2 in list1 Example:
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = [3,4]
 *
 * <p>Output: 2
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = [6,7]
 *
 * <p>Output: -1
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = []
 *
 * <p>Output: -1
 *
 ...
 * <p>Output: -1
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = [1,2,3,4,5]
 *
 * <p>Output: 0
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = [5]
 *
 * <p>Output: 4
 *
 * <p>Input: list1 = [1,2,3,4,5], list2 = [1]
 *
 * <p>Output: 0
 */
import java.io.*;
...
public class SubListIndex {
  ...
  private boolean findHelper(int startIndex) {
    ...
    while (startIndex < list1.size()
        && list2Tracker < list2.size()
