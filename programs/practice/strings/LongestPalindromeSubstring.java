...
public class LongestPalindromeSubstring {
    ...
    /*
     * O(n^2) : running complexity O(1) : space complexity This is most efficient
     * amongst 3 implementations
     */
    public static int lps(String s) {
        ...
        System.out.println(
                "Longest Palindrome String : " + s.substring(start, start + maxLength) + " Length : " + maxLength);
    ...
    /*
     * It keeps track of palindrome strings starting with single character and then
     * 2 character strings Then it checks for strings with length 3 characters or
     * more. It uses already obtained knowledge of palindrome strings This is O(n^2)
     * solution but at the same time it also requires O(n^2) space
     */
    public static int lpsDynamic(String s) {
        ...
        if (s != null) {
            ...
            for (int k = 3; k <= length; ++k) {// all string with length 3 or more
                for (int i = 0; i + (k - 1) < length; ++i) {// i = 0 to length governed by K e.g. if k = 3, i will be
                                                            // max (length - 3)
