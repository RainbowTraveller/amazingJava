/**
 * Definition for an interval. Merge intervals indicated by a start and an end
 *
 * <p>e.g. (1, 4), (2, 6), (2, 3), (40, 45), (10, 12)
 *
 * <p>First sort : (1, 4), (2, 6), (2, 3), (10, 12), (40, 45)
 *
 * <p>Final Result : (1, 6), (10, 12), (40, 45)
 */
...
public class MergeIntervals {
  ...
  /**
   * Merge all overlapping intervals in a list of intervals Here overlapping means that some part of
   * one interval lies within another The approach is to sort the intervals based on start time and
   * then iterate through them merging them as needed
   *
   * @param intervals List of intervals to be merged
   ...
   * then iterate through them merging them as needed
   *
   * @param intervals 2D array of intervals to be merged
