...
public class FuturesExceptions {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        task.thenApply(e -> e * 2).thenApply(e -> e + 1).exceptionally(throwable -> logFailure(throwable))
                .thenAccept(System.out::println).exceptionally(throwable -> logFailure2(throwable));
