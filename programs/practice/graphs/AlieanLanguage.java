...
public class AlieanLanguage {
  ...
  /**
   * Finding the alphabetical order using topographical sort First check if building a graph is
   * possible and there is not cycle Once the graph is built then topographical sort is implemented
   *
   * @param words string from the alien language in sorted manner
   * @return string containing alphabetical order
   */
  ...
  public boolean bulildGraph(
      int[] inDegree, Map<Character, List<Character>> graph, String[] words) {
    // Initialize
