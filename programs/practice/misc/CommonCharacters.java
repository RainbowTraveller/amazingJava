...
public class CommonCharacters {
    public static void main(String[] args) {
        ...
        /*
         * input.add(new String("bella")); input.add(new String("label")); input.add(new
         * String("roller"));
         */
    ...
    /**
     * Get set of common characters across all strings
     */
    ...
    /**
     * Get occurrences of characters in all string and get min one. That many times
     * a character occurs in the 3 strings
     */
