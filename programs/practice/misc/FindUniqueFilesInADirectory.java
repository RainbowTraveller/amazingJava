...
public class FindUniqueFilesInADirectory {
    ...
    public static List<List<String>> getSameFilePaths( String path ) {
        if( path != null ) {
            ...
            pathStack.push( path );
            //Map of Checksum to Path
            //Checksum should be same for all the identical files
            ...
            while(!pathStack.isEmpty()) {
                ...
                if( isDir( currentPath ) ) {
                    ...
                    //Java 8 : for each and method reference
                    currSubPaths.forEach(pathStack::push);
                } else {
    ...
    private static void processFile( String filePath, Map<String, List<String>> sameFileTracker ) {
        ...
        List<String> sameFilePaths = sameFileTracker.getOrDefault(currCheckSum, new ArrayList<String>());
