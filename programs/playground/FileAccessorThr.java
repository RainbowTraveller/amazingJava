        ...
        try (
            ...
            FileChannel channel = outputStream.getChannel();
                ...
                while((line = reader.readLine()) != null) {
                    if(lock == null) {
                        lockCount++;
                        System.out.println("THR lock requested");
                        ...
                        System.out.println("THR lock acquired : " + lockCount);
                    }
                    writer.println("THR : " + line);
                    writer.flush();
                    count++;
                    totalCount++;
                    if(count == 20) {
                        ...
                        System.out.println("THR : Sleeping......");
                        Date date = new Date();
                        System.out.println(format.format(date));
                        Thread.sleep(5000);
                        date = new Date();
                        System.out.println(format.format(date));
                        System.out.println("THR : Up and running......");
                    }
                }
            } catch(IOException ioe) {
                ioe.printStackTrace();
